...
function ReportsContent() {
  ...
  return (
    <div className="">
      ...
      {timeReport.some((report) => report.isUnderutilized) && (
          ...
          <AccordionItem value="utilization-issues">
            <AccordionTrigger className="flex gap-2 text-amber-700 dark:text-amber-400">
              <div className="flex items-center gap-2">
                ...
                <span>
                  Utilization Issues (
                  {timeReport.filter((r) => r.isUnderutilized).length}{" "}
                  employees)
                </span>
              </div>
            </AccordionTrigger>
                ...
                {(
                  Object.entries(
                    timeReport
                      ...
                      .reduce((acc, report) => {
                        const reason =
                          report.underutilizationReason || "Unknown";
                    ...
                    <div className="pl-4 text-sm text-amber-700 dark:text-amber-400 space-y-1">
                      {reports.map((report) => (
                        ...
                        >
                          ...
                          <span>
                            Week of{" "}
                            {format(new Date(report.week), "MMM d, yyyy")}
                          </span>
                          <span className="text-amber-600 dark:text-amber-500">
                            •
                          </span>
